...
GtkWidget *create_user_screen(void) {
    ...
    gtk_builder_add_object(builder, "password_entry", GTK_OBJECT(password_entry)); // Add to builder
    ...
    gtk_builder_add_object(builder, "confirm_password_entry", GTK_OBJECT(confirm_password_entry)); // Add to builder
    ...
    gtk_builder_add_object(builder, "password_match_label", GTK_OBJECT(password_match_label)); // Add to builder
